...
public class PostAdapter extends ArrayAdapter<PostModels> {

    PostAdapter(@NonNull Context context, ArrayList<PostModels> arrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        PostModels models = getItem(position);
        if (models != null) {
